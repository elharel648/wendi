...
export const modules: Module[] = [
  {
    ...
    color: "#A8C5F5",
    colorSoft: "rgba(168, 197, 245, 0.18)",
    gradient: "linear-gradient(135deg, #A8C5F5 0%, #C8DBF8 100%)",
  ...
  },
  {
    ...
    color: "#A8E0B5",
    colorSoft: "rgba(168, 224, 181, 0.18)",
    gradient: "linear-gradient(135deg, #A8E0B5 0%, #C8EDD0 100%)",
  ...
  },
  {
    ...
    color: "#FFCBA0",
    colorSoft: "rgba(255, 203, 160, 0.18)",
    gradient: "linear-gradient(135deg, #FFCBA0 0%, #FFDDC0 100%)",
  ...
  },
  {
    ...
    color: "#F5B5AE",
    colorSoft: "rgba(245, 181, 174, 0.18)",
    gradient: "linear-gradient(135deg, #F5B5AE 0%, #F8CFCA 100%)",
