...
export const modules: Module[] = [
  {
    ...
    features: [
      ...
      { title: "מבנה ארגוני", desc: "ניהול אוטומטי של היררכיה ארגונית והצגתה", icon: ico(<><rect width="16" height="20" x="4" y="2" rx="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></>) },
      ...
      { title: "גלריית תמונות", desc: "אלבומי אירועים, הורדה לטלפון, תגובות ולייקים", icon: ico(<><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></>) },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "הזמנות ציוד", desc: "הזמנת ציוד, מדים, אוכל ועוד — בתהליך מסודר", icon: ico(<><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/></>) },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "למידה שוטפת", desc: "רענון, מעקב אחר פגי תוקף והכשרות חוזרות", icon: ico(<><path d="M3 2v6h6"/><path d="M21 12A9 9 0 0 0 6 5.3L3 8"/><path d="M21 22v-6h-6"/><path d="M3 12a9 9 0 0 0 15 6.7l3-2.7"/></>) },
    ],
  },
  {
    id: "performance",
