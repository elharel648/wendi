...
export const homeSections: HomeSectionsContent = {
  ...
  mobile: {
    ...
    categories: [
      { title: "תקשורת פנים-ארגונית", desc: "פורטלי עובדים חכמים עם עדכוני חברה, צ'אט מובנה ודחיפות מותאמות אישית — הכל תחת מותג הארגון שלכם." },
      { title: "בריאות ורפואה", desc: "אפליקציות לקופות חולים ומרפאות — תורים, הפניות, בדיקות ומידע רפואי בנגישות מלאה מהנייד." },
      { title: "ארנק והטבות", desc: "ניהול תקציב עובד, הטבות ותגמולים, תוכניות נאמנות וארנק דיגיטלי — הכל בממשק אחד נקי." },
      { title: "למידה ופיתוח", desc: "פלטפורמות e-learning עם קורסי חובה, מבחני ציות ומסלולי הכשרה מותאמים לכל תפקיד בארגון." },
      { title: "כלים וניהול", desc: "כלי ניהול פנימי לממשקי Back-Office, לוחות בקרה, אדמין ועוד — מותאמים לתפעול יומיומי." },
    ],
  },
};
